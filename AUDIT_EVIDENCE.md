...
| Rust core and SBF-shell tests | In-crate test modules; CI runs test, Clippy and rustfmt | Present; 45 core tests plus 3 entrypoint fail-closed tests include asymmetric exits, FIFO claims, strict decoding/account layouts, transaction composition, nonces and 128 open/close sequences |

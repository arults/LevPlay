...
| Canonical program-owned state layouts | [`programs/levplay-core/src/state_accounts.rs`](./programs/levplay-core/src/state_accounts.rs), [`PROGRAM_STATE_V1.md`](./PROGRAM_STATE_V1.md) | Present; strict 208-byte config and 392-byte market decoders reject bad versions, lengths, reserved bytes, bounds, zero and aliased addresses |
| State-v2 audit candidate | [`programs/levplay-core/src/state_v2.rs`](./programs/levplay-core/src/state_v2.rs), [`programs/levplay-sbf/src/state_v2_validation.rs`](./programs/levplay-sbf/src/state_v2_validation.rs), [`PROGRAM_STATE_V2.md`](./PROGRAM_STATE_V2.md) | Present but unused; separates immutable config, mutable accounting, paired risk vault and wallet position with exact layouts and canonical PDA/role validation. No initialization, mutation, CPI or release-verifier support exists. |

...
export default function DocsPage() {
  return <main className="landing-shell">
    ...
    <section className="landing-section" id="product">
      <div className="section-heading"><span className="eyebrow">LevPlay documentation</span><h1>Proof-first leverage.</h1><p>LevPlay is designed as a defined-risk leveraged stock-token layer on Solana. Holders receive a token—not a margin debt account—and can never owe more than they paid.</p></div>
    ...
    <section className="landing-section" id="difference">
      <div className="section-heading"><span className="eyebrow">The LevPlay difference</span><h2>Built between tokenized stocks and margin trading.</h2><p>Tokenized-stock platforms provide underlying exposure. Perpetual venues provide leverage through collateral accounts and liquidation engines. LevPlay is designed to package managed daily leverage into a directly held token with isolated, inspectable backing.</p></div>
      <div className="benefit-grid">
    ...
    <footer className="landing-footer"><div><strong>LevPlay</strong><p>Solana’s proof-first, defined-risk leveraged stock-token layer.</p></div><nav><strong>Contact</strong><a href="mailto:info@levplay.tech">info@levplay.tech</a><a href="https://x.com/lev__play" target="_blank" rel="noreferrer">X / @lev__play</a></nav><nav><strong>Links</strong><Link href="/">Homepage</Link><a href={APP_URL}>Trading app</a></nav><div className="landing-legal"><span>© 2026 LevPlay</span><p>Experimental software. Not investment advice. Availability is jurisdiction-dependent.</p></div></footer>
  </main>;
}

  ...
  return <main className="landing-shell">
    ...
    <section className="landing-section" id="why">
      ...
      <div className="benefit-grid">
        ...
        <article><RefreshCw/><span>02</span><h3>Rebalance, then Standby</h3><p>The vault targets 2×, 3× or 5× exposure, deleverages as risk rises, and stops exposure at its funded residual-NAV floor.</p></article>
    ...
    <section className="dark-section" id="mechanics">
      <div className="mechanics-intro"><span className="eyebrow">One simple position</span><h2>Leveraged stock tokens, made clear.</h2><p>Each LevPlay market packages a managed daily leverage target into a token. Ondo provides public-stock and commodity-linked source assets; PreStocks adds pre-IPO economic-exposure references. xStocks is shelved. The ticket shows the exact provider, product, fee, target exposure and settlement status.</p></div>

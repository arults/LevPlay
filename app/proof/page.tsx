...
const evidence = [
  ...
  { title: "Reference data", state: "PASS", detail: "PreStocks, Tessera and DEX marks are isolated as display-only and cannot authorize value movement.", proof: "REFERENCE_DATA_POLICY.md" },

  ...
  return <main className="app-shell">
    ...
    <section className="trading-grid">
      ...
      <div className="detail-panel">
        ...
        <MarketDecisionChart key={selected.symbol} symbol={selected.symbol} name={selected.name} category={selected.category} onDisplayPrice={applyDisplayPrice}/>

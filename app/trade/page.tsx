  ...
  return <main className="app-shell">
    ...
    <section className="docs-section" id="docs">
      ...
      <div className="docs-cards">
        ...
        <article id="oracles"><ShieldCheck/><span><small>03 · Pricing</small><h3>Pyth-first prices fail closed</h3></span><p>Pyth is primary only where an exact product feed exists and passes owner, freshness and confidence checks. Ondo API, PreStocks DEX and Tessera issuer marks are display-only; Tessera currently supplies no observation timestamp. Missing corroboration, stale prices, issuer halts, paused mints or mismatched identities stop activity.</p></article>

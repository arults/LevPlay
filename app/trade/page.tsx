...
export default function TradingApp() {
  ...
  return <main className="app-shell">
    ...
    {view === "trade" && <><section className="market-hero">
      <div><span className="eyebrow">Public stocks via xStocks · pre-IPO references via PreStocks · Solana</span><h1>Trade leveraged tokens.<br/><em>Not margin accounts.</em></h1></div>

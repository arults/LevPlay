...
The parallel [state-v2 audit candidate](../../PROGRAM_STATE_V2.md) freezes exact
immutable-config, mutable-accounting, paired-risk-vault and per-wallet-position
layouts plus canonical PDA/role loaders. These `*02` layouts are deliberately
unused by the entrypoint and release verifier; they add no initialization,
mutation, CPI or migration path.

...
assert.ok(page.includes("levplay-paper-v1"), "paper portfolio and history must persist locally");
...
console.log("LevPlay source security: 38 fail-closed assertions passed");

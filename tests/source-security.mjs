...
assert.ok(page.includes("levplay-paper-v2"), "paper portfolio and history must persist locally under the fee-on-top schema");
...
console.log("LevPlay source security: 45 fail-closed assertions passed");
